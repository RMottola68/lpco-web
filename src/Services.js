            ...
            <div className={'container'}>
                <div className={'row row-cols-3'}>
                    <ul className={'col-12 col-lg-6 col-xl-4 list-group mb-5'}><h2 className={'border-bottom'}>Hair Design</h2>
                        ...
                        <h4 className={'d-flex justify-content-between list-group-item'}>Scalp Treatments<span className={'d-flex'}>$30<h6 className={'text-danger'}>$30.90</h6></span></h4>
                        ...
                        <h4 className={'d-flex justify-content-between list-group-item'}>Glaze (Alone)<span className={'justify-content-between d-flex ml-5'}>$30<h6 className={'text-danger'}>$30.90</h6>-$40<h6 className={'text-danger'}>$41.2</h6></span></h4>
                        ...
                        <h4 className={'d-flex justify-content-between list-group-item'}>Highlites (Partial)<span className={'justify-content-between d-flex ml-5'}>$65<h6 className={'text-danger'}>$66.95</h6>-$125<h6 className={'text-danger'}>$128.75</h6></span></h4>
                    ...
                    <h4 className={'d-flex justify-content-between list-group-item'}>Threading<span className={'d-flex'}>$12<h6 className={'text-danger'}>$12.36</h6>-$30<h6 className={'text-danger'}>$30.90</h6></span></h4>
                        ...
                        <h4 className={'d-flex justify-content-between text-danger list-group-item'}>Manicure & Pedicure<span className={'d-flex'}>$30<h6 className={'text-danger'}>$30.90</h6></span></h4>
                    </ul>
