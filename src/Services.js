            ...
            <div className={'container'}>
                <div className={'row row-cols-3'}>
                    <ul className={'col-12 col-lg-4 list-group mb-5'}><h2 className={'border-bottom'}>Hair Design</h2>
                        ...
                        <h4 className={'d-flex justify-content-between text-start list-group-item'}>Children's Haircuts Under 12<span className={'my-auto align-text-start'}>$20<h6 className={'text-danger'}>$20.6</h6>-$25<h6 className={'text-danger'}>$25.75</h6></span></h4>
                        ...
                        <h4 className={'d-flex justify-content-between list-group-item'}>Special Effects & Relaxers<span className={'my-auto'}>$65<h6 className={'text-danger'}>$66.95</h6>-$150<h6 className={'text-danger'}>$154.05</h6></span></h4>
                        ...
                        <h4 className={'d-flex justify-content-between text-start list-group-item'}>Permanent Single Process W/ Glaze<div className={'my-auto'}>$61<h6 className={'text-danger'}>$62.83</h6>-$75<h6 className={'text-danger'}>$77.25</h6></div></h4>
                        <h4 className={'d-flex justify-content-between list-group-item'}>Semi Permanent<span className={'justify-content-between'}>$55<h6 className={'text-danger'}>$56.65</h6>-$65<h6 className={'text-danger'}>$66.95</h6></span></h4>
                        <h4 className={'d-flex justify-content-between list-group-item'}>Glaze (Alone)<span className={'justify-content-between'}>$30<h6 className={'text-danger'}>$30.9</h6>-$40<h6 className={'text-danger'}>$41.2</h6></span></h4>
                        <h4 className={'d-flex justify-content-between list-group-item'}>Highlites (Full Head)<span className={'justify-content-between my-auto'}>$85<h6 className={'text-danger'}>$87.55</h6>-$200<h6 className={'text-danger'}>$206</h6></span></h4>
                        <h4 className={'d-flex justify-content-between list-group-item'}>Highlites (Partial)<span className={'justify-content-between'}>$65<h6 className={'text-danger'}>$66.95</h6>-$125<h6 className={'text-danger'}>$206</h6></span></h4>
                        <h4 className={'d-flex justify-content-between list-group-item'}>Hairline Touch-Up<span className={'justify-content-between'}>$36<h6 className={'text-danger'}>$37.08</h6></span></h4>
                    </ul>
                    ...
                    <ul className={'col-12 col-lg-4 list-group'}><h2 className={'border-bottom'}>Manicure & Pedicure</h2>
                        ...
                        <h4 className={'d-flex justify-content-between text-start list-group-item'}>SNS Powder Manicure / French<span className={'my-auto'}>$40<h6 className={'text-danger'}>$41.20</h6>/$50<h6 className={'text-danger'}>$51.50</h6></span></h4>
                        ...
                        <h4 className={'d-flex justify-content-between text-start list-group-item'}>Change of Polish<span className={'d-flex justify-content-end w-100'}>Fingers $10<h6 className={'text-danger'}>$10.30</h6> <br></br>Toes $15<h6 className={'text-danger'}>$15.45</h6></span></h4>
                        <h4 className={'d-flex justify-content-between text-start list-group-item'}>Change of French Polish<span className={'d-flex justify-content-end w-100 my-auto'}>Fingers $13<h6 className={'text-danger'}>$13.39</h6> <br></br>Toes $20<h6 className={'text-danger'}>$20.60</h6></span></h4>
                        ...
                        <h4 className={'d-flex justify-content-between text-start list-group-item'}>Glue Down<span className={'d-flex justify-content-end w-100'}>$8<h6 className={'text-danger'}>$8.24</h6> <br/>Single Wrap $5<h6 className={'text-danger'}>$5.15</h6></span></h4>
