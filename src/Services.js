            ...
            <div className={'container'}>
                <div className={'row row-cols-3'}>
                    <ul className={'col-12 col-lg-4 list-group mb-5'}><h2 className={'border-bottom'}>Hair Design</h2>
                        ...
                        <h4 className={'d-flex justify-content-between list-group-item'}>Highlites (Full Head)<span className={'justify-content-between my-auto'}>$85-$200</span></h4>
                        <h4 className={'d-flex justify-content-between list-group-item'}>Highlites (Partial)<span className={'justify-content-between'}>$65-$125</span></h4>
                    ...
                    <h4 className={'d-flex justify-content-between list-group-item'}>Threading<span className={''}>$12-$30</span></h4>
                        ...
                        <h4 className={'d-flex justify-content-between list-group-item'}>Lip Wax<span className={''}>$9</span></h4>
                        <h4 className={'d-flex justify-content-between list-group-item'}>Chin Wax<span className={''}>$9</span></h4>
                        <h4 className={'d-flex justify-content-between list-group-item'}>Eyebrow Wax<span className={''}>$10</span></h4>
                        <h4 className={'d-flex justify-content-between list-group-item'}>Sides of Face Wax<span className={''}>$12</span></h4>
                        <h3 className={'text-decoration-underline list-group pb-3'}>B O D Y</h3>
                        <h4 className={'d-flex justify-content-between list-group-item'}>Brazilian<span className={''}>$40</span></h4>
                        <h4 className={'d-flex justify-content-between list-group-item'}>Half-Leg<span className={''}>$23</span></h4>
                        <h4 className={'d-flex justify-content-between list-group-item'}>Full-Leg<span className={''}>$45</span></h4>
                        <h4 className={'d-flex justify-content-between list-group-item'}>Bikini<span className={''}>$18</span></h4>
                        ...
                        <h4 className={'d-flex justify-content-between text-danger list-group-item'}>Full-Leg W/ Bikini<span className={''}>$42</span></h4>
                        <h4 className={'d-flex justify-content-between text-danger list-group-item'}>Manicure & Pedicure<span className={''}>$30</span></h4>
                    </ul>
                    <ul className={'col-12 col-lg-4 list-group'}><h2 className={'border-bottom'}>Manicure & Pedicure</h2>
                        ...
                        <h4 className={'d-flex justify-content-between list-group-item'}>Manicure / French<span className={''}>$15/$18</span></h4>
                        <h4 className={'d-flex justify-content-between list-group-item'}>Shellac Gel Manicure<span className={''}>$35</span></h4>
                        <h4 className={'d-flex justify-content-between text-start list-group-item'}>SNS Powder Manicure / French<span className={'my-auto'}>$40/$50</span></h4>
