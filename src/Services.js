            ...
            <div className={'container'}>
                <div className={'row row-cols-3'}>
                    <ul className={'col-12 col-lg-4 list-group mb-5'}><h2 className={'border-bottom'}>Hair Design</h2>
                        ...
                        <h4 className={'d-flex justify-content-between list-group-item'}>Children's Haircuts Under 12<span className={'my-auto'}>$20-$25</span></h4>
                        ...
                        <h4 className={'d-flex justify-content-between list-group-item'}>Permanent Single Process W/ Glaze<div className={'my-auto'}>$61-$75</div></h4>
                    ...
                    <ul className={'col-12 col-lg-4 list-group'}><h2 className={'border-bottom'}>Manicure & Pedicure</h2>
                        ...
                        <h4 className={'d-flex justify-content-between list-group-item'}>SNS Powder Manicure / French<span className={''}>$38/$48</span></h4>
                        ...
                        <p className={'d-flex justify-content-between fs-5'}>French Pedicure<span className={''}>$28</span></p>
